          ...
          <div className="md:w-1/4 lg:w-1/4 mb-[-200px] md:mt-[350px] lg:mt-[350px] ml-2 md:ml-[63%] lg:ml-[63%] flex justify-center items-center md:absolute lg:absolute">
            <div className="flex sm:flex-col items-center flex-row ">
              <div className="flex items-center">
                <button className="md:mb-10 lg:mb-10 mt-14 md:mt-1 transform transition-all hover:-translate-y-2 duration-300 bg-white text-black font-extrabold font-Spartan lg:text-base md:text-sm text-xs md:p-2 lg:p-5 p-1 mr-2">EMPEZAR AHORA</button>
                <button className="lg:mb-10 md:mb-10 hidden md:inline-block lg:mt-1 md:mt-1 lg:ml-0 md:ml-0 -ml-72 transform transition-all hover:-translate-y-2 duration-300 bg-white">
