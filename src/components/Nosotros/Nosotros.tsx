    ...
    <section id="Nosotros" className="flex text-center md:mt-32 mt-32 lg:mt-0">
      <div className="flex items-center justify-center w-full">
        <div className=' w-full sm:w-1/2 flex flex-col items-center sm:items-start pr-10'>
          ...
          <p className='sm:text-left mt-10 ml-[10%] sm:ml-10 font-Spartan text-xl'>Contamos con programas, talleres, instructorados,<br /> certificaciones y rutinas de entrenamiento<br/>inovadoras que brindan experiencias positivas y<br/>llenas de energía para todas las personas<br /> que lo practican.</p>
